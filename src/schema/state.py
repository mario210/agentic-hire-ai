...
class JobOffer(BaseModel):
    ...
    salary_range: Optional[str] = Field(default="N/A", description="Salary info if available")
    match_score: float = Field(default=0.0, description="Semantic match score from 0 to 1")
